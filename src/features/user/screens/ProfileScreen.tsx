      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View className="items-center pt-16 pb-8 px-6">
          ...
          <View className="flex-row items-center gap-x-1.5 bg-brand-light px-3 py-1 rounded-full">
            <Ionicons name="car-outline" size={12} color="#1B5E37" />
        ...
        <View className="flex-row mx-4 gap-x-3 mb-6">
          <View className="flex-1 bg-bg-card rounded-2xl p-4 items-center shadow-card">
            ...
            <Text className="text-xs text-text-muted mt-1">Phone</Text>
          ...
          <View className="flex-1 bg-bg-card rounded-2xl p-4 items-center shadow-card">
            ...
            <Text className="text-xs text-text-muted mt-1">City</Text>
            <Text className="text-sm font-semibold text-text-primary mt-0.5 capitalize">
              {user?.tenant_schema ?? "—"}
            </Text>
          </View>
          <View className="flex-1 bg-bg-card rounded-2xl p-4 items-center shadow-card">
            <Ionicons name="mail-outline" size={18} color="#1B5E37" />
            <Text className="text-xs text-text-muted mt-1">Email</Text>
            <Text className="text-xs font-semibold text-text-primary mt-0.5" numberOfLines={1}>
              {user?.email ?? "—"}
            </Text>
          </View>
        </View>
